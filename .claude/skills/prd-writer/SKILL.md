...
- `PROGRESS_PATH`: Full path for the progress file. Defaults to `{OUTPUT_FOLDER}/prd_progress.json` when not provided
...
**PRD Structure Example:** see `references/prd-example.md` if you need a structural reference.
